<div class="modal fade modal-xl" id="listnotes" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Anotações Anamnese Corporal</h1>
      ...
      <div class="modal-body" style="width: 100%; margin:0 auto;">
        ...
        <div style="width: 100%;">
        <form action="/note/1/{{$cliente->anamnese->id ?? ''}}" method="post">
            @csrf
        <div class="row">
...
@if(isset($cliente->anamnese))
            @foreach($cliente->anamnese->notes as $note)
                <div class="note">
